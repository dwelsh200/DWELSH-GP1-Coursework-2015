...
void cTieFighter::update(float deltaTime)
{
...
=================================================================
*/
void cTieFighter::setTieFighterVelocity(glm::vec2 TieFighterVel)
{
	TieFighterVelocity = TieFighterVel;
}
/*
=================================================================
...
=================================================================
*/
glm::vec2 cTieFighter::getTieFighterVelocity()
{
	return TieFighterVelocity;
}
/*
==========================================================================
...
==========================================================================
*/
void cTieFighter::renderCollisionBox()
{
	glPushMatrix();
